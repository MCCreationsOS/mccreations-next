...
import styles from './ContentListCard.module.css'
...
import { IContentCardProps } from "../ContentSlideshow/ContentCard";
 ...
 */
export default function ContentListCard(props: IContentCardProps) {
    ...
    return (
        ...
        <div className={styles.content_card} id={props.playlist + "_" + props.index} >
            <div className={styles.logo_container}>
                <Link href={`/${(props.linkTo) ? props.linkTo : props.content.type + "s"}/${props.content.slug}`}>
