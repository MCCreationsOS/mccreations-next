...
import { Check, CheckCheck, CheckIcon, CircleIcon } from "lucide-react"
  ...
  return (
    ...
    >
      <RadioGroupPrimitive.Indicator
        ...
        className="relative flex items-center justify-center"
      >
        <Check className="absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 w-4 h-4" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}

export { RadioGroup, RadioGroupItem, RadioGroupCheckItem }
