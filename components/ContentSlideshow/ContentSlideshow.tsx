    ...
    return (
        <div className={styles.slideshow}>
            ...
            <div className={styles.scroll_window} id={playlist}>
                {content.map((map: IContentDoc, idx: number) => <ContentCard key={map._id} content={map} playlist={playlist} index={idx} priority={true} adPosition={adPosition}></ContentCard>)}
            </div>
        </div>
    )
}