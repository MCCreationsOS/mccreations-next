    ...
    return (
        <div className={`flex flex-row gap-2 items-center ${props.className}`}>
            <ul className="rating" onMouseMove={(e) => {ratingHover(e)}} onMouseLeave={() => {setValue(props.value)}}>
                ...
                <li><Button variant="none" className="w-6 h-4 p-0" id="one" title={t('Components.Creations.Page.Rating.1')} onClick={() => {props.onRate(0.2)}}></Button></li>
                <li><Button variant="none" className="w-6 h-4 p-0" id="two" title={t('Components.Creations.Page.Rating.2')} onClick={() => {props.onRate(0.4)}}></Button></li>
                <li><Button variant="none" className="w-6 h-4 p-0" id="three" title={t('Components.Creations.Page.Rating.3')} onClick={() => {props.onRate(0.6)}}></Button></li>
                <li><Button variant="none" className="w-6 h-4 p-0" id="four" title={t('Components.Creations.Page.Rating.4')} onClick={() => {props.onRate(0.8)}}></Button></li>
                <li><Button variant="none" className="w-6 h-4 p-0" id="five" title={t('Components.Creations.Page.Rating.5')} onClick={() => {props.onRate(1)}}></Button></li>
            </ul>
