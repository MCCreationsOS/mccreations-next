...
export default function Page({ params }: { params: Params }) {
    ...
    if (!content) return <div className="centered_content">{t('Content.affiliate')}</div>
                ...
                <div className="centered_content">
                    <div className='map_title_bar'>
                        ...
                        <div className='map_download_stack'>
                            ...
                            <Link title={t(`Content.affiliate`, {type: t('map', {count: 2})})} href="https://www.minecraft-hosting.pro/?affiliate=468862"><IconButton><Server /></IconButton></Link>
                        </div>
                    </div>
