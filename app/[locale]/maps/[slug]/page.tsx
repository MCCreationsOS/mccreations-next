...
export async function generateMetadata(props: { params: Promise<{locale: string, slug: string}> }, parent: ResolvingMetadata): Promise<Metadata> {
    ...
    return {
        title: t('Pages.Maps.slug.Metadata.title', {title: map.title, content_type: t('map', {count: 1}), creator: map.creators && map.creators.length > 0 ? map.creators[0].username : "", minecraft_version: (map.files && map.files.length > 0) ? ( typeof map.files[0].minecraftVersion === 'object' ? map.files[0].minecraftVersion.join(", ") : map.files[0].minecraftVersion ?? "") : ""}),
        ...
        keywords: map.tags.concat([t('Pages.Maps.slug.Metadata.Tags.minecraft'), t('map', {count: 2}), t('Pages.Maps.slug.Metadata.Tags.games'), t('Pages.Maps.slug.Metadata.Tags.gaming'), t('Pages.Maps.slug.Metadata.Tags.minecraft_map'), t('Pages.Maps.slug.Metadata.Tags.minecraft_creations'), t('Pages.Maps.slug.Metadata.Tags.minecraft_version', {minecraft_version: (map.files && map.files.length > 0) ? ( typeof map.files[0].minecraftVersion === 'object' ? map.files[0].minecraftVersion.join(", ") : map.files[0].minecraftVersion ?? "") : ""}), t('Pages.Maps.slug.Metadata.Tags.maps'), t('Pages.Maps.slug.Metadata.Tags.minecraft_games'), t('Pages.Maps.slug.Metadata.Tags.download'), t('Pages.Maps.slug.Metadata.Tags.minecraft_adventure'), t('Pages.Maps.slug.Metadata.Tags.minecraft_parkour'), t('Pages.Maps.slug.Metadata.Tags.minecraft_pvp'), t('Pages.Maps.slug.Metadata.Tags.minecraft_skyblock'), t('Pages.Maps.slug.Metadata.Tags.minecraft_survival'), t('Pages.Maps.slug.Metadata.Tags.minecraft_creative'), t('Pages.Maps.slug.Metadata.Tags.minecraft_minigames')]),
