        ...
        <>
            <div className="centered_content">
                ...
                <p><strong>Effective Date: </strong><em>August 5th, 2023</em></p><p>
                    <strong>Last reviewed on: </strong><em>August 5th, 2023</em></p>
                ...
                <p> Our Service collects information that identifies, relates to, describes, references, is capable of being associated with, or could reasonably be linked, directly or indirectly, with a particular consumer or device (<strong>"personal information"</strong>). In particular, our Service has collected the following categories of personal information from its consumers within the last twelve (12) months: </p>
                ...
                <p> To exercise the access, data portability, and deletion rights described above, please submit a verifiable consumer request to us by emailing us at <a href="mailto:crazycowmm@gmail.com">crazycowmm@gmail.com</a>. </p>
                ...
                <p> For instructions on exercising sale opt-out rights, see <i>Personal Information Sales Opt-Out and Opt-In Rights.</i></p>
                ...
                <p> We reserve the right to amend this privacy notice at our discretion and at any time. When we make changes to this privacy notice, we will post the updated notice on the Service and update the notice's effective date. <strong>Your continued use of our Service following the posting of changes constitutes your acceptance of such changes. </strong></p>
                <h2>Contact Information</h2>
                <p> If you have any questions or comments about this notice, the ways in which we collect and use your information described below and in the <a href="/privacy_policy" className="">Privacy Policy</a>, your choices and rights regarding such use, or wish to exercise your rights under California law, please do not hesitate to contact us at <a href="mailto:crazycowmm@gmail.com">crazycowmm@gmail.com</a>.
                </p>
            </div>
        </>
    )
