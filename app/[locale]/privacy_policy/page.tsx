...
export default function Page() {
    ...
    <div className="centered_content">
        ...
        <p>Last modified: August 7, 2024</p>
        <h3>Introduction</h3>

        <p>MCCreations is owned and operated by Benjamin Meier ("Company", "us", "we", "our"). This privacy policy explains how we collect data, process it, and your rights relative to your data.</p>

        <p>This policy describes the types of information we may collect from you or that you may provide when you use www.mccreations.net, or api.mccreations.net ("Service" or "Website"), and our practices for collecting, using, maintaining, protecting, and disclosing that information.</p>
        ...
        <ul>
            <li>the California Consumer Privacy Act (CA CCPA), more information about which can be found on <Link href="https://oag.ca.gov/privacy/ccpa">oag.ca.gov</Link></li>
            <li>the European Union General Data Protection Regulation (EU GDPR), more information about which can be found on <Link href="https://gdpr.eu/">gdpr.eu</Link></li>
        </ul>
        ...
        <h4>View data and download data</h4>
        ...
        <p>We use cookies to track some information about your session, like what content you have downloaded or rated.</p>

        <p>Cookies are text files placed on your computer to collect standard Internet information. For more information, please visit <Link href="https://allaboutcookies.org/">allaboutcookies.org</Link>.</p>
        ...
        <h3>Access, rectification, erasure, restriction, portability, and objection</h3>
        ...
        <p>If you would like to exercise those rights, contact us at crazycowmm@gmail.com. We may ask you to verify your identity before proceeding and will respond to your request within 30 days as required by law, or notify you of an extended reply time.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in MCCreations. This policy is not applicable to any information collected offline or via channels other than this website.</p>
        <h3>Consent</h3>

        <p>By using our website, you hereby consent to our Privacy Policy and agree to its Terms and Conditions.</p>
        <h3>California Privacy Rights</h3>

        <p>If you are a California resident, California law may provide you with additional rights regarding our use of your personal information. To learn more about your California privacy rights, visit <Link href="/ccpa">this page.</Link></p>

        <p>California's "Shine the Light" law (Civil Code Section § 1798.83) permits users of our App that are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. To make such a request, please send an email to crazycowmm@gmail.com.</p>
        <h3>Changes to the Privacy Policy</h3>

        <p>We keep this privacy policy under regular review and place any updates on this web page. If we do this, we will post the changes on this page and update the "Last edited" date at the top of this page, after which such changes will become effective immediately. We will make an effort to keep users updated on any such changes, but because most changes do not affect how we process existing data, a notice will not be sent for all changes.</p>
        <h3>Contact</h3>

        <p>If you have any questions about this privacy policy or how we process your data, contact us at crazycowmm@gmail.com.</p>
    </div >
    </>)
}